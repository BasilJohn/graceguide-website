    ...
    <div className="min-h-screen bg-[#F8F7F5] dark:bg-[#1A2332] text-[#1F1F1F] dark:text-[#F5F3F0]">
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        <article className="rounded-3xl bg-white dark:bg-[#1E2835] border border-[#E5E3E0] dark:border-[#374151] p-8 md:p-10 shadow-sm">
          ...
          <section className="rounded-xl border border-[#E5E3E0] dark:border-[#374151] bg-[#F8F7F5] dark:bg-[#1A2332]/50 p-6">
            <h2 className="text-xl font-semibold mb-4 text-[#1F1F1F] dark:text-[#F5F3F0]">3. Important Health &amp; Safety Disclaimer</h2>
            <p className="mb-3">GraceGuide is not designed to assist with crises such as abuse, severe mental health conditions, feelings of suicide or self-harm, or any other medical emergencies. GraceGuide cannot and will not offer medical, clinical, or pastoral advice. It can only suggest that users seek professional medical, mental health, or spiritual care as appropriate.</p>
            <p className="font-medium text-[#1F1F1F] dark:text-[#F5F3F0]">In case of emergency, please reach out to your country-specific crisis or suicide prevention hotline.</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold mb-4 text-[#1F1F1F] dark:text-[#F5F3F0]">4. Eligibility</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-4 text-[#1F1F1F] dark:text-[#F5F3F0]">5. User Accounts</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-4 text-[#1F1F1F] dark:text-[#F5F3F0]">6. User Content</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-4 text-[#1F1F1F] dark:text-[#F5F3F0]">7. Intellectual Property</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-4 text-[#1F1F1F] dark:text-[#F5F3F0]">8. Prohibited Uses</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-4 text-[#1F1F1F] dark:text-[#F5F3F0]">9. AI Services Disclaimer</h2>
            <p className="mb-2">AI-generated responses may not always be accurate, complete, or current. You should not rely solely on AI-generated information for important decisions. We are not responsible for the content, accuracy, or quality of AI-generated responses. The AI chat feature is not a substitute for professional mental health, medical, or pastoral care. We may modify, suspend, or discontinue AI features at any time.</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold mb-4 text-[#1F1F1F] dark:text-[#F5F3F0]">10. Termination</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-4 text-[#1F1F1F] dark:text-[#F5F3F0]">11. Disclaimers</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-4 text-[#1F1F1F] dark:text-[#F5F3F0]">12. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-4 text-[#1F1F1F] dark:text-[#F5F3F0]">13. Indemnification</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-4 text-[#1F1F1F] dark:text-[#F5F3F0]">14. Changes to Terms</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-4 text-[#1F1F1F] dark:text-[#F5F3F0]">15. Governing Law</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-4 text-[#1F1F1F] dark:text-[#F5F3F0]">16. Contact Information</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-4 text-[#1F1F1F] dark:text-[#F5F3F0]">17. Severability</h2>
